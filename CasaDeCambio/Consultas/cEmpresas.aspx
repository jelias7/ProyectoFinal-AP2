<%@ Page Title="Consulta de Empresas" Language="C#" MasterPageFile="~/Master.Master" AutoEventWireup="true" CodeBehind="cEmpresas.aspx.cs" Inherits="CasaDeCambio.Consultas.cEmpresas" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="Contenido" runat="server">
    ...
    <asp:GridView ID="Grid" runat="server" class="table table-condensed table-responsive" AutoGenerateColumns="true" ShowHeaderWhenEmpty="True" DataKeyNames="EmpresaId" CellPadding="4" ForeColor="Black" GridLines="None">
