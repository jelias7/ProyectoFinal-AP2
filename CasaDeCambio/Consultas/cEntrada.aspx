<%@ Page Title="" Language="C#" MasterPageFile="~/Master.Master" AutoEventWireup="true" CodeBehind="cEntrada.aspx.cs" Inherits="CasaDeCambio.Consultas.cEntrada" %>
...
<div class="panel panel-primary">
    ...
    <asp:GridView ID="Grid" runat="server" class="table table-condensed table-responsive" AutoGenerateColumns="true" ShowHeaderWhenEmpty="True" DataKeyNames="CajaId" CellPadding="4" ForeColor="Black" GridLines="None">
